...
public class ZooKangrooValidation {
    ...
    public static  void chechKangrooExistence(Map<Integer, Kangaroo> kangaroos,Integer id,boolean existence){
if(existence){
    ...
    public static void chechKangarooWeight(Double weight){
